...
def process_file(f):
    ...
    for func in bv.functions:
        ...
        if func.mlil is None:
            print(f"Error: {func.name} has no valid MLIL")
            continue
    ...
    with open('/home/kingdom/PalmTree-master/src/dfg_train.txt', 'a') as w:
...
def main():
    bin_folder = '/home/kingdom/PalmTree-master/src/bin'
    file_lst = []
    str_counter = Counter()
